...
var file_protob_message_proto_goTypes = []interface{}{
	(*MessageWrapper)(nil),         // 0: SafeMPC.tsslib.MessageWrapper
	(*MessageWrapper_PartyID)(nil), // 1: SafeMPC.tsslib.MessageWrapper.PartyID
	(*anypb.Any)(nil),              // 2: google.protobuf.Any
}
var file_protob_message_proto_depIdxs = []int32{
	1, // 0: SafeMPC.tsslib.MessageWrapper.from:type_name -> SafeMPC.tsslib.MessageWrapper.PartyID
	1, // 1: SafeMPC.tsslib.MessageWrapper.to:type_name -> SafeMPC.tsslib.MessageWrapper.PartyID
	2, // 2: SafeMPC.tsslib.MessageWrapper.message:type_name -> google.protobuf.Any
