...
var file_protob_eddsa_resharing_proto_goTypes = []interface{}{
	(*DGRound1Message)(nil),  // 0: SafeMPC.tsslib.eddsa.resharing.DGRound1Message
	(*DGRound2Message)(nil),  // 1: SafeMPC.tsslib.eddsa.resharing.DGRound2Message
	(*DGRound3Message1)(nil), // 2: SafeMPC.tsslib.eddsa.resharing.DGRound3Message1
	(*DGRound3Message2)(nil), // 3: SafeMPC.tsslib.eddsa.resharing.DGRound3Message2
	(*DGRound4Message)(nil),  // 4: SafeMPC.tsslib.eddsa.resharing.DGRound4Message
}
