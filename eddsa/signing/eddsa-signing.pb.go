...
var file_protob_eddsa_signing_proto_goTypes = []interface{}{
	(*SignRound1Message)(nil), // 0: SafeMPC.tsslib.eddsa.signing.SignRound1Message
	(*SignRound2Message)(nil), // 1: SafeMPC.tsslib.eddsa.signing.SignRound2Message
	(*SignRound3Message)(nil), // 2: SafeMPC.tsslib.eddsa.signing.SignRound3Message
}
