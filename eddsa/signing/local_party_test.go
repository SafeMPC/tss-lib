...
import (
	...
	"github.com/SafeMPC/tss-lib/test"
...
// testStandardEd25519Verification tests whether tss-lib signatures can be verified with standard Ed25519
func testStandardEd25519Verification(
	...
	// Method 1: Directly use tss-lib output (little-endian, conforms to RFC 8032)
	...
	// Method 3: Try various byte order conversions
	t.Log("\n--- Method 3: Trying different byte order conversions ---")

	// 3.1: Reverse entire signature
	...
	// 3.2: Reverse R and S separately
	...
	// 3.4: Reverse both public key and signature
