...
var file_protob_ecdsa_resharing_proto_goTypes = []interface{}{
	(*DGRound1Message)(nil),  // 0: SafeMPC.tsslib.ecdsa.resharing.DGRound1Message
	(*DGRound2Message1)(nil), // 1: SafeMPC.tsslib.ecdsa.resharing.DGRound2Message1
	(*DGRound2Message2)(nil), // 2: SafeMPC.tsslib.ecdsa.resharing.DGRound2Message2
	(*DGRound3Message1)(nil), // 3: SafeMPC.tsslib.ecdsa.resharing.DGRound3Message1
	(*DGRound3Message2)(nil), // 4: SafeMPC.tsslib.ecdsa.resharing.DGRound3Message2
	(*DGRound4Message2)(nil), // 5: SafeMPC.tsslib.ecdsa.resharing.DGRound4Message2
	(*DGRound4Message1)(nil), // 6: SafeMPC.tsslib.ecdsa.resharing.DGRound4Message1
}
