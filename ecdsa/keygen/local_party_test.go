...
import (
	...
	"github.com/SafeMPC/tss-lib/crypto/dlnproof"
	"github.com/SafeMPC/tss-lib/crypto/paillier"
	"github.com/SafeMPC/tss-lib/crypto/vss"
...
func TestBadMessageCulprits(t *testing.T) {
	...
	assert.Equal(t,
		"task ecdsa-keygen, party {0,P[1]}, round 1, culprits [{1,2}]: message failed ValidateBasic: Type: SafeMPC.tsslib.ecdsa.keygen.KGRound1Message, From: {1,2}, To: all",
		err2.Error())
}
